...
ARTICLES = [
  ...
  # ─── 27 ──────────────────────────────────────────────
  {
    "slug":        "ossobuco-alla-milanese-ricetta",
    "title":       "Ossobuco alla Milanese Ricetta Originale — La Vera Ricetta Lombarda Tradizionale",
    "desc":        "La vera ricetta dell'ossobuco alla milanese: stinchi di vitello brasati lentamente nel vino bianco con gremolata di limone, aglio e prezzemolo. Il capolavoro della cucina lombarda tradizionale.",
    "tag":         "Secondi",
    "tag_color":   "#c62828",
    "tag_bg":      "#ffebee",
    "h1":          "Ossobuco alla Milanese Ricetta Originale — Il Brasato Più Amato di Lombardia",
    "intro":       "L'ossobuco alla milanese è uno dei piatti simbolo della cucina lombarda: stinchi di vitello tagliati trasversalmente, infarinati e rosolati, poi brasati lentamente per ore nel vino bianco e brodo fino a quando la carne cade dall'osso e il midollo si scioglie come burro. Il segreto è la gremolata — la miscela di scorza di limone, aglio e prezzemolo fresco che si aggiunge all'ultimo momento e trasforma un piatto ricco in qualcosa di brillante e vivo. Tradizionalmente servito con il risotto alla milanese allo zafferano, è il pranzo della domenica lombarda per eccellenza.",
    "prep":        "15 min", "cook": "1h 30min", "total": "1h 45min",
    "servings":    "4 porzioni", "calories": "~520", "difficulty": "Medio",
    "badge_text":  "Milanese",
    "cuisine":     "Italiana",
    "category":    "Secondi",
    "keywords":    "ossobuco alla milanese ricetta originale, ossobuco ricetta, ossobuco con gremolata, come fare l'ossobuco, stinco di vitello brasato",
    "cal_num":     "520", "protein": "48g", "fat": "22g", "carbs": "18g",
    "ingredients": [
      "4 stinchi di vitello tagliati trasversalmente (ossobuco), spessi 4-5cm",
      ...
      "2 spicchi d'aglio, tritati",
      "200ml vino bianco secco (es. Pinot Grigio o Soave)",
      "300ml brodo di carne caldo",
      "1 lattina (400g) pomodori pelati (per la versione con pomodoro)",
      "2 foglie di alloro, 2 rametti di timo",
      "Per la Gremolata: scorza grattugiata di 1 limone biologico",
      "1 spicchio d'aglio, tritato finissimo",
      "3 cucchiai di prezzemolo fresco tritato",
    ],
    "steps": [
      "Incidi il bordo degli stinchi con un taglio superficiale in 2-3 punti (evita che si arriccino in cottura). Asciuga bene con carta da cucina. Sala e pepa generosamente su entrambi i lati, poi infarina, scrollando via l'eccesso.",
      "In una casseruola larga e dai bordi alti, scalda l'olio EVO con il burro a fuoco medio-alto. Rosola gli stinchi 3-4 minuti per lato fino a doratura intensa. Non affrettare: la rosolatura sigilla i succhi e dà colore al fondo di cottura. Togli gli stinchi e mettili da parte.",
      "Nella stessa casseruola, abbassa il fuoco a medio. Soffriggi cipolla, carote e sedano per 8-10 minuti, mescolando, finché sono morbidi e dorati. Aggiungi l'aglio e cuoci 1 minuto.",
      "Sfuma con il vino bianco, alzando il fuoco. Lascia evaporare completamente l'alcol raschiando il fondo per incorporare il soffritto dorato (il fondo di cottura è sapore puro).",
      "Rimetti gli stinchi nella casseruola. Aggiungi i pomodori pelati spezzati, il brodo caldo, l'alloro e il timo. Il liquido deve arrivare a metà altezza degli stinchi. Porta a ebollizione.",
      "Copri con coperchio e cuoci a fuoco bassissimo per 1 ora e 30 minuti, girando gli stinchi delicatamente ogni 30 minuti. La carne è pronta quando si stacca dall'osso con una leggera pressione e il midollo nell'osso è completamente sciolto.",
      "Prepara la gremolata: mescola scorza di limone grattugiata, aglio tritato finissimo e prezzemolo fresco in una ciotolina. Regola il fondo di cottura di sale. Impiatta gli stinchi, nappal con il fondo e cospargi generosamente con la gremolata. Servi subito, con un cucchiaino apposito per il midollo.",
    ],
    "tips": [
      "Incidi i bordi degli stinchi per evitare che si arriccino in cottura.",
      "La rosolatura intensa è fondamentale: crea il sapore del fondo di cottura.",
      "Il fuoco deve essere bassissimo durante la brasatura: non deve bollire, solo sobbollire.",
      "La gremolata si aggiunge all'ultimo momento — mai durante la cottura.",
    ],
    "prose1_h2":  "La Gremolata: Il Segreto dell'Ossobuco Milanese",
    "prose1":     """La gremolata — scorza di limone, aglio crudo e prezzemolo — è l'elemento che distingue l'ossobuco alla milanese da qualsiasi altro brasato italiano. Non va cotta: si aggiunge all'ultimissimo momento, sopra la carne calda, così che il calore sprigioni gli oli essenziali del limone e dell'aglio senza farli evaporare. Il contrasto tra la ricchezza del brasato e la freschezza brillante della gremolata è la firma del piatto. Alcune ricette tradizionali aggiungono anche acciughe nella gremolata (una variante più antica) per una nota umami profonda. Se la ometti, servi comunque dell'ossobuco buono, ma non l'ossobuco alla milanese originale.""",
    "prose2_h2":  "Con o Senza Pomodoro? La Disputa tra le Versioni dell'Ossobuco",
    "prose2":     """Esiste un acceso dibattito tra i cuochi milanesi: l'ossobuco originale è 'in bianco' (senza pomodoro) o 'in rosso' (con pomodori)? La versione più antica è quella in bianco, con solo vino bianco, brodo e verdure. I pomodori pelati sono stati introdotti successivamente, probabilmente nell'Ottocento. Entrambe le versioni sono autentiche e diffuse. La versione in bianco è più delicata e lascia emergere il sapore puro del vitello; quella in rosso ha una salsa più corposa e saporita. La ricetta qui presentata usa i pomodori nella quantità tradizionale — pochissimi, solo per dare corpo alla salsa senza dominarla.""",
    "img2_alt":   "Ossobuco alla milanese con gremolata di limone e prezzemolo nel piatto fondo, con il midollo dell'osso a vista",
    "prose3_h2":  "Conservazione e il Giorno Dopo: L'Ossobuco Migliora",
    "prose3":     """L'ossobuco alla milanese è uno di quei piatti che migliora notevolmente il giorno dopo: il fondo di cottura si addensa, i sapori si amalgamano e la carne diventa ancora più tenera. Si conserva in frigorifero per 3-4 giorni in un contenitore ermetico. Per riscaldarlo: aggiungi un goccio di brodo e scalda a fuoco basso coperto per 10-15 minuti, oppure in forno a 160°C per 20 minuti. Prepara la gremolata fresca al momento di servire — non conservare quella avanzata. Il fondo di cottura è eccellente anche come condimento per la pasta o per insaporire il risotto.""",
    "faqs": [
      ("Quale taglio di carne si usa per l'ossobuco?", "L'ossobuco è il gambo (stinco) di vitello tagliato trasversalmente, in modo che ogni fetta includa l'osso con il midollo al centro. I tagli da 4-5cm di spessore sono ideali. Il midollo dell'osso che si scioglie durante la cottura è la parte più pregiata del piatto — si mangia con un cucchiaino, spalmato sul pane o sul risotto."),
      ("Posso fare l'ossobuco con il manzo invece del vitello?", "Sì, ma il risultato è diverso. Il manzo richiede tempi di cottura più lunghi (2-2,5 ore) e ha un sapore più intenso. Il vitello è più tradizionale perché ha la carne più tenera e il midollo più abbondante. Se usi il manzo, abbassa ulteriormente il fuoco e controlla che non si asciughi, aggiungendo brodo se necessario."),
      ("Con cosa si serve l'ossobuco alla milanese?", "Tradizionalmente con il risotto alla milanese allo zafferano — il giallo del risotto e il marrone del brasato sono l'abbinamento iconico della cucina lombarda. In alternativa si serve con la polenta gialla, con purè di patate o, più semplicemente, con pane casereccio per raccogliere il fondo. Non si serve mai con la pasta."),
      ("Posso cucinare l'ossobuco in pentola a pressione?", "Sì — riduci i tempi a 35-40 minuti ad alta pressione dopo la rosolatura e il soffritto. Lascia sfiatare naturalmente per 10 minuti. Il risultato è eccellente. Aggiungi la gremolata fresca al momento di servire. La pentola a pressione è ideale per rendere l'ossobuco un piatto infrasettimanale."),
      ("Perché il mio ossobuco è duro?", "La causa è quasi sempre il calore troppo alto durante la brasatura. Il fuoco deve essere bassissimo — il liquido deve appena sobbollire, mai bollire vigorosamente. La bollitura forte indurisce le proteine della carne invece di sciogliere il collagene. Abbassa il fuoco e allunga i tempi di cottura: 30 minuti in più a fuoco basso fanno una differenza enorme."),
    ],
  },

  # ─── 28 ──────────────────────────────────────────────
  {
    "slug":        "pasta-allarrabbiata-ricetta",
    "title":       "Pasta all'Arrabbiata Ricetta Originale Romana — Veloce, Piccante e Autentica",
    "desc":        "La vera ricetta della pasta all'arrabbiata romana: pomodoro San Marzano, aglio e peperoncino. Pronta in 25 minuti, autentica, piccante al punto giusto. La pasta più semplice e più buona di Roma.",
    "tag":         "Pasta",
    "tag_color":   "#1565c0",
    "tag_bg":      "#e3f2fd",
    "h1":          "Pasta all'Arrabbiata Ricetta Originale Romana — La Pasta Piccante di Roma",
    "intro":       "L'arrabbiata è la pasta più essenziale di Roma: pomodoro, aglio, peperoncino e olio extravergine d'oliva. Nient'altro. Niente cipolla, niente carne, niente panna. La semplicità è la sua forza — e il segreto è saper usare quei quattro ingredienti al massimo del loro potenziale. Il nome viene dal peperoncino che fa 'arrabbiare' chi la mangia, facendogli salire il sangue alla testa. La ricetta originale è senza pancetta (quella è l'amatriciana), senza acciughe (quella è la puttanesca), senza cipolla. Solo aglio e peperoncino nell'olio, poi pomodoro di qualità, poi la pasta. In 25 minuti.",
    "prep":        "5 min", "cook": "20 min", "total": "25 min",
    "servings":    "2 porzioni", "calories": "~420", "difficulty": "Facile",
    "badge_text":  "25 Min",
    "cuisine":     "Italiana",
    "category":    "Pasta",
    "keywords":    "pasta all'arrabbiata ricetta originale, penne all'arrabbiata ricetta, sugo all'arrabbiata, arrabbiata ricetta romana, pasta piccante ricetta italiana",
    "cal_num":     "420", "protein": "13g", "fat": "14g", "carbs": "62g",
    "ingredients": [
      "200g penne rigate (o rigatoni)",
      "400g pomodori pelati San Marzano (o passata di pomodoro densa)",
      "3 spicchi d'aglio, sbucciati e leggermente schiacciati",
      "2-3 peperoncini secchi interi (o 1 cucchiaino di peperoncino in scaglie)",
      "4 cucchiai olio extravergine d'oliva di qualità",
      "Sale grosso per l'acqua della pasta",
      "Prezzemolo fresco tritato (opzionale, per finire)",
      "Pecorino Romano grattugiato (facoltativo ma tradizionale)",
    ],
    "steps": [
      "Scalda l'olio extravergine d'oliva in una padella larga a fuoco medio. Aggiungi gli spicchi d'aglio interi schiacciati e i peperoncini secchi interi. Cuoci lentamente per 3-4 minuti, finché l'aglio è dorato su tutti i lati e l'olio è profumato di peperoncino. L'aglio non deve bruciare — brunito chiaro, non scuro.",
      "Rimuovi l'aglio (e i peperoncini se li vuoi meno piccanti). Se li lasci, la pasta sarà più intensa. Schiaccia i pomodori pelati con le mani direttamente nella padella — la consistenza a pezzi irregolari è parte del piatto. Aggiungi sale.",
      "Alza il fuoco a medio-alto. Cuoci il sugo per 12-15 minuti mescolando occasionalmente, finché si addensa, l'olio sale in superficie e il colore diventa rosso intenso. Un buon sugo all'arrabbiata non è acquoso.",
      "Nel frattempo, porta a ebollizione abbondante acqua salata. Cuoci le penne fino a 2 minuti prima del tempo indicato — finiranno in padella.",
      "Scola le penne conservando una tazza di acqua di cottura. Trasferiscile nel sugo e fai saltare a fuoco alto per 2 minuti, aggiungendo qualche cucchiaio di acqua di cottura per legare e lucidare la pasta. La pasta deve essere avvolta dalla salsa, non annegata.",
      "Impiatta subito. Cospargi con prezzemolo fresco tritato e, se gradito, una spolverata di Pecorino Romano. Un filo d'olio EVO a crudo completa il piatto.",
    ],
    "tips": [
      "L'aglio non deve bruciare: dorato chiaro, non scuro — l'aglio bruciato rende il sugo amaro.",
      "Pomodori San Marzano: fanno la differenza. Sono più dolci e meno acidi dei pomodori standard.",
      "Tieni i peperoncini interi per un sapore più controllato; tritali per più piccante diffuso.",
      "Non aggiungere mai acqua al sugo — usa solo l'acqua di cottura della pasta.",
    ],
    "prose1_h2":  "La Disputa sull'Arrabbiata: Con o Senza Cipolla? Con o Senza Prezzemolo?",
    "prose1":     """L'arrabbiata è uno di quei piatti romani dove ogni famiglia ha la 'ricetta vera'. La versione più tradizionale e semplice è solo aglio, peperoncino, pomodoro e olio — niente cipolla. La cipolla ammorbidisce il piatto e lo avvicina a un sugo generico; l'aglio invece dà il carattere pungente che distingue l'arrabbiata. Il prezzemolo finale è menzionato in alcune fonti storiche e in molte cucine romane tradizionali — altri lo considerano superfluo. Il Pecorino Romano grattugiato sopra è controverso: i puristi lo escludono (niente formaggio sul pesce, niente formaggio sull'arrabbiata piccante), i romani comuni lo usano liberamente. Scegli la tua versione, ma l'aglio e il peperoncino sono non negoziabili.""",
    "prose2_h2":  "Penne o Rigatoni? La Scelta del Formato per l'Arrabbiata",
    "prose2":     """Le penne rigate sono il formato canonico dell'arrabbiata — le righe trattengono il sugo e i fori centrali catturano pezzi di pomodoro in modo che ogni boccone sia pieno di sapore. I rigatoni sono un'ottima alternativa, più grandi e con un buco più largo. I bucatini funzionano bene per chi vuole un formato più tradizionale romano. La pasta corta è preferita perché il sugo si accumula nella forma invece di scivolar via come su formati lunghi come spaghetti o linguine. Mai usare pasta fresca o all'uovo con l'arrabbiata — è sempre pasta secca di semola.""",
    "img2_alt":   "Penne all'arrabbiata nel piatto bianco con sugo di pomodoro rosso intenso, aglio e peperoncino visibili",
    "prose3_h2":  "Conservazione del Sugo e Varianti Popolari",
    "prose3":     """Il sugo all'arrabbiata si conserva in frigorifero per 4-5 giorni in un barattolo chiuso, e migliora dopo 24 ore. È ottimo anche come base per la pizza, come intingolo per il pane, o come salsa per le polpette. Si può congelare per 3 mesi. Per una variante più ricca, aggiungi alla fine una manciata di olive nere di Gaeta e capperi dissalati — diventa qualcosa a metà tra l'arrabbiata e la puttanesca, non canonica ma deliziosa. Per una versione vegana, il piatto è già naturalmente vegano: nessun ingrediente di origine animale nella ricetta base.""",
    "faqs": [
      ("La vera arrabbiata ha la cipolla?", "No — la ricetta originale romana dell'arrabbiata usa solo aglio, non cipolla. La cipolla addolcisce e ammorbidisce troppo il sapore, avvicinando il piatto a un sugo generico. L'aglio è il carattere distintivo dell'arrabbiata. Se aggiungi la cipolla ottieni comunque una buona pasta, ma non l'arrabbiata autentica."),
      ("Quanto deve essere piccante l'arrabbiata?", "Abbastanza da 'arrabbiare' — deve creare una leggera sensazione di calore persistente, non bruciare. La dose standard è 2-3 peperoncini secchi per 200g di pasta. Regola secondo la forza del tuo peperoncino: le scaglie di peperoncino essiccate variano molto di piccante. Inizia con meno e aggiungi a piacere."),
      ("Posso usare i pomodori freschi invece dei pelati?", "Sì, in estate con pomodori maturi e saporiti (San Marzano freschi, Roma, cuore di bue). Pelali prima (incidi una X, sbollenta 30 secondi, elimina la pelle). I pelati in scatola sono più affidabili e concentrati durante tutto l'anno — la San Marzano DOP in scatola è spesso superiore ai pomodori freschi fuori stagione."),
      ("Perché il mio sugo all'arrabbiata è acido?", "L'acidità eccessiva dipende quasi sempre dalla qualità dei pomodori. Usa San Marzano DOP. Se il sugo è comunque acido, aggiungi un pizzico di zucchero (non più di mezzo cucchiaino) o un goccio d'olio EVO a fine cottura per bilanciare. La cottura lunga del sugo riduce anche naturalmente l'acidità concentrando gli zuccheri."),
      ("Si usa il Pecorino o il Parmigiano sull'arrabbiata?", "Tradizionalmente il Pecorino Romano — salato e pungente, si abbina al carattere forte del peperoncino e del pomodoro molto meglio del Parmigiano più delicato. Detto questo, molte famiglie romane usano il Parmigiano. Alcuni puristi non mettono nessun formaggio sull'arrabbiata piccante. Scegli tu."),
    ],
  },

  # ─── 29 ──────────────────────────────────────────────
  {
    "slug":        "bruschetta-al-pomodoro-ricetta",
    "title":       "Bruschetta al Pomodoro Ricetta Originale Italiana — Semplice, Autentica e Perfetta",
    "desc":        "La vera ricetta della bruschetta al pomodoro: pane casereccio tostato, pomodori freschi conditi con aglio, basilico e olio extravergine d'oliva. L'antipasto italiano più famoso del mondo in 15 minuti.",
    "tag":         "Antipasti",
    "tag_color":   "#e65100",
    "tag_bg":      "#fff3e0",
    "h1":          "Bruschetta al Pomodoro Ricetta Originale — L'Antipasto Italiano Più Amato del Mondo",
    "intro":       "La bruschetta al pomodoro è la prova che la cucina italiana è superiore non per complessità ma per qualità degli ingredienti. È pane, pomodoro, aglio, olio e basilico. Cinque ingredienti. Ma quando il pane è casereccio tostato sulla griglia fino a diventare croccante e profumato di fumo, quando il pomodoro è maturo al punto giusto e condito con il sale che lo fa rilasciare il suo succo dolce, quando l'aglio sfrega il pane caldo e si scioglie nel calore della mollica, quando l'olio extravergine è fruttato e il basilico fresco — la bruschetta diventa qualcosa di memorabile. La differenza tra una bruschetta mediocre e una perfetta è solo questo: ingredienti di qualità.",
    "prep":        "10 min", "cook": "5 min", "total": "15 min",
    "servings":    "4 porzioni", "calories": "~180", "difficulty": "Facile",
    "badge_text":  "15 Min",
    "cuisine":     "Italiana",
    "category":    "Antipasti",
    "keywords":    "bruschetta al pomodoro ricetta originale, bruschetta ricetta, come fare la bruschetta, bruschetta italiana originale, antipasto italiano bruschetta",
    "cal_num":     "180", "protein": "5g", "fat": "8g", "carbs": "24g",
    "ingredients": [
      "8 fette di pane casereccio (o pane di Altamura, o pane di grano duro), spesse 1,5-2cm",
      "4 pomodori maturi sodi (tipo Roma, San Marzano, o pomodori ciliegini misti)",
      "2 spicchi d'aglio, sbucciati e interi",
      "6-8 foglie di basilico fresco",
      "4 cucchiai olio extravergine d'oliva di qualità — l'ingrediente centrale",
      "Sale fino (e sale grosso per i pomodori)",
      "Pepe nero macinato fresco",
      "Opzionale: un filo d'aceto balsamico di Modena IGP",
    ],
    "steps": [
      "Taglia i pomodori a cubetti di circa 1cm, eliminando i semi e l'acqua in eccesso (i semi rendono la bruschetta liquida). Metti i cubetti in una ciotola, condisci con un pizzico di sale e lascia riposare 5-10 minuti. Il sale estrae il succo dolce dal pomodoro.",
      "Tosta il pane sulla griglia ben calda (o nel tostapane) finché ha segni bruni decisi su entrambi i lati e la crosta è croccante. Il pane deve essere caldo e profumato di bruciacchiato — non solo riscaldato.",
      "Subito dopo la tostatura, strofina con decisione uno spicchio d'aglio su ogni fetta di pane ancora caldo. L'aglio si consuma come una spugna sul pane caldo e lascia il sapore senza essere pungente. Non saltare questo passaggio.",
      "Scola eventuali succhi in eccesso dai pomodori. Aggiungi le foglie di basilico spezzate con le mani (non tagliate — l'ossidazione del coltello le annerisce). Un filo d'olio EVO sui pomodori.",
      "Disponi il condimento di pomodoro sulle fette di pane all'aglio. Versaci sopra l'olio extravergine d'oliva a filo generoso — non essere timido. Aggiungi una macinata di pepe nero. Servi immediatamente: la bruschetta aspetta nessuno.",
    ],
    "tips": [
      "Il pane deve essere tostato sulla griglia, non nel forno: il contatto diretto con il fuoco dà il carattere affumicato.",
      "Sfrega l'aglio sempre sul pane caldo appena tostato — il calore apre i pori della mollica.",
      "Usa pomodori a temperatura ambiente, mai freddi di frigorifero: perdono profumo e dolcezza.",
      "Olio EVO abbondante — non risparmiare: è il sapore centrale della bruschetta autentica.",
    ],
    "prose1_h2":  "La Vera Pronunzia e l'Origine della Bruschetta",
    "prose1":     """Si pronuncia 'bru-SKET-ta' — non 'bru-SHET-ta'. Il CH in italiano è sempre duro (come in 'schema'), non morbido come in inglese. La bruschetta nasce nel Lazio e in Umbria come piatto contadino: il pane raffermo veniva tostato sul fuoco, strofinato con aglio, condito con olio extravergine d'oliva nuovo (la bruschetta era tradizionalmente il modo dei frantoi oleari di assaggiare l'olio appena prodotto) e sale. Il pomodoro è stato aggiunto successivamente, dopo l'arrivo del pomodoro in Italia. La versione con pomodoro fresco è quella oggi più diffusa nel mondo, ma la bruschetta originale è semplicemente pane, aglio e olio — la migliore merenda rurale italiana.""",
    "prose2_h2":  "Quale Pane per la Bruschetta? Tutta la Differenza è nel Pane",
    ...
    "img2_alt":   "Bruschetta al pomodoro su tagliere di legno, con cubetti di pomodoro rosso maturo, basilico fresco e filo di olio EVO",
    "prose3_h2":  "Varianti della Bruschetta Originale: dal Classico al Creativo",
    "prose3":     """La bruschetta al pomodoro è la versione più famosa, ma in Italia si fa la bruschetta con tutto. Bruschetta con ricotta e fichi (Umbria). Bruschetta con nduja e stracciatella (Calabria). Bruschetta con lardo di Colonnata e miele (Toscana). Bruschetta con funghi porcini trifolati (Toscana, autunno). Bruschetta bianca, solo aglio e olio, è la versione più antica e in molte regioni la preferita. Per i vegetariani: bruschetta con pesto di rucola e noci. Per chi vuole più sostanza: bruschetta con fagioli cannellini, salvia e olio — un piatto quasi completo. La base — pane tostato, aglio, olio buono — rimane sempre la stessa.""",
    "faqs": [
      ("Come si pronuncia bruschetta?", "Si pronuncia 'bru-SKET-ta' con il CH duro italiano, come in 'schema' o 'scheda'. Non 'bru-SHET-ta' come spesso si sente fuori dall'Italia. Il termine deriva dal verbo dialettale romano 'bruscare' (abbrustolire) e dall'umbro 'bruscato' (bruciacchiato)."),
      ("Si usa l'aglio crudo strofinato o l'aglio cotto?", "L'aglio viene strofinato crudo direttamente sul pane caldo appena tostato — non viene cotto a parte. Questo è il metodo tradizionale: il calore del pane 'cuoce' leggermente l'aglio sulla superficie, lasciando il sapore senza la pungenza dell'aglio completamente crudo. Non aggiungere mai aglio crudo tritato sopra la bruschetta: sarebbe troppo aggressivo."),
      ("Posso preparare la bruschetta in anticipo?", "No — la bruschetta va consumata immediatamente. Il pomodoro condito rilascia liquidi che ammollano il pane in pochi minuti. Puoi preparare il condimento di pomodoro in anticipo (si conserva 30-60 minuti), tostare il pane all'ultimo momento, assemblare e servire subito. Non lasciare riposare la bruschetta già assemblata."),
      ("La bruschetta va nel forno o sulla griglia?", "La griglia è preferita perché dà i segni di bruciacchiato caratteristici e il sapore affumicato. Il tostapane va bene per uso quotidiano. Il forno (grill/broiler) funziona per grandi quantità. Non usare il microonde: il pane diventa gommoso invece di croccante."),
      ("Quali pomodori sono i migliori per la bruschetta?", "Pomodori carnosi e poco acquosi: i San Marzano, i pomodori Roma, i cuore di bue o i ciliegini misti dolci. Usali a temperatura ambiente, mai freddi di frigo. In estate, qualsiasi pomodoro maturo di campo è eccellente. In inverno, i pomodorini ciliegini o i datterini sono i più saporiti tra quelli disponibili."),
    ],
  },

  # ─── 30 ──────────────────────────────────────────────
  {
    "slug":        "gnocchi-alla-sorrentina-ricetta",
    "title":       "Gnocchi alla Sorrentina Ricetta Originale — Il Comfort Food Campano al Forno",
    "desc":        "La vera ricetta degli gnocchi alla sorrentina: gnocchi di patate al forno con sugo di pomodoro San Marzano, mozzarella filante e Parmigiano. Il capolavoro campano gratinato in 45 minuti.",
    "tag":         "Pasta",
    "tag_color":   "#1565c0",
    "tag_bg":      "#e3f2fd",
    "h1":          "Gnocchi alla Sorrentina Ricetta Originale — Filante, Gratinata, Campana",
    "intro":       "Gli gnocchi alla sorrentina sono il piatto simbolo della costa amalfitana e della Penisola Sorrentina: morbidi gnocchi di patate, sugo di pomodoro San Marzano profumato di basilico, mozzarella di bufala (o fior di latte) che fonde in fili lunghissimi, e Parmigiano Reggiano gratinato in superficie. Si comincia sul fornello e si finisce in forno — la mantecatura finale trasforma il piatto da buono a straordinario. Il segreto è l'equilibrio tra la dolcezza del pomodoro campano, la grassezza della mozzarella e la sapidità del Parmigiano. Questo è comfort food italiano al massimo livello.",
    "prep":        "15 min", "cook": "30 min", "total": "45 min",
    "servings":    "4 porzioni", "calories": "~480", "difficulty": "Facile",
    "badge_text":  "Sorrentina",
    "cuisine":     "Italiana",
    "category":    "Pasta",
    "keywords":    "gnocchi alla sorrentina ricetta originale, gnocchi al forno ricetta, gnocchi pomodoro mozzarella, gnocchi alla sorrentina, pasta al forno campana",
    "cal_num":     "480", "protein": "20g", "fat": "18g", "carbs": "58g",
    "ingredients": [
      "800g gnocchi di patate freschi (o 500g secchi)",
      "700ml passata di pomodoro San Marzano (o pelati frullati)",
      "2 spicchi d'aglio",
      "4 cucchiai olio extravergine d'oliva",
      "10 foglie di basilico fresco",
      "Sale, pepe, un pizzico di zucchero",
      "300g mozzarella di bufala (o fior di latte), ben sgocciolata",
      "80g Parmigiano Reggiano DOP grattugiato",
      "Burro per imburrare la teglia",
    ],
    "steps": [
      "Prepara il sugo: soffriggi l'aglio nell'olio EVO per 1-2 minuti. Aggiungi la passata di San Marzano, sale, pepe, un pizzico di zucchero e metà del basilico. Cuoci a fuoco medio per 15-20 minuti fino a ottenere un sugo saporito e leggermente addensato. Togli l'aglio. Regola di sale.",
      "Metti a sgocciolare la mozzarella (o il fior di latte) su un piatto con carta cucina per almeno 20-30 minuti. L'acqua in eccesso è il nemico degli gnocchi alla sorrentina — se non la elimini, il piatto diventa acquoso. Poi tagliala a dadini piccoli.",
      "Cuoci gli gnocchi in abbondante acqua salata bollente: sono pronti quando vengono a galla (circa 2-3 minuti per i freschi). Scolali con la schiumarola e versali direttamente in una padella con metà del sugo caldo. Mescola delicatamente per insaporire.",
      "Preriscalda il forno a 200°C (modalità grill/ventilato). Imburra una teglia da forno (o usa cocotte monoporzione per una presentazione elegante). Stendi uno strato di sugo sul fondo.",
      "Versa gli gnocchi conditi nella teglia. Aggiungi la mozzarella a dadini distribuita in modo uniforme e il sugo rimanente. Cospargi con il Parmigiano Reggiano grattugiato in strato generoso. Aggiungi qualche foglia di basilico fresco sopra.",
      "Inforna per 10-15 minuti finché il Parmigiano è gratinato e dorato, la mozzarella è completamente sciolta e filante, e i bordi della teglia borbottano. Lascia riposare 3-4 minuti prima di servire. Il filo di mozzarella è il segno del piatto riuscito.",
    ],
    "tips": [
      "Sgocciola bene la mozzarella: l'acqua in eccesso rende il piatto acquoso.",
      "Non cuocere troppo gli gnocchi in acqua: escono dal forno molto più cotti.",
      "Gratina forte: il Parmigiano deve dorarsi per dare croccantezza in contrasto con i gnocchi morbidi.",
      "Le cocotte monoporzione sono eleganti e mantengono il calore più a lungo.",
    ],
    "prose1_h2":  "La Storia degli Gnocchi alla Sorrentina e il Legame con i Pelati San Marzano",
    "prose1":     """Gli gnocchi alla sorrentina nascono nella Penisola Sorrentina, in Campania, in una delle zone d'Italia con la concentrazione più alta di ingredienti di qualità straordinaria: il pomodoro San Marzano (coltivato alle pendici del Vesuvio, con la sua dolcezza unica), la mozzarella di bufala campana (la più ricca e cremosa del mondo), il basilico napoletano profumato. La ricetta è semplice per necessità storica — era il piatto della cucina povera campana, fatto con quello che c'era. La fortuna di Sorrento è stata quella di avere intorno a sé i migliori prodotti d'Italia per fare qualcosa di così semplice diventare così buono.""",
    "prose2_h2":  "Gnocchi Freschi o Secchi? Mozzarella di Bufala o Fior di Latte?",
    "prose2":     """Per gli gnocchi alla sorrentina, i gnocchi freschi di patate danno la consistenza migliore — morbidi dentro, con una leggera crosta fuori dopo il passaggio in forno. Gli gnocchi secchi confezionati funzionano altrettanto bene e sono più pratici. Per la mozzarella: la bufala campana DOP è la scelta tradizionale e la più saporita, ma contiene più acqua — va sgocciolata a lungo. Il fior di latte (mozzarella di latte vaccino) è meno saporito ma fonde meglio e rilascia meno liquidi: ottima alternativa pratica. Per una versione di lusso, usa la burrata al posto della mozzarella — il suo cuore cremoso si scioglie nel sugo caldo in modo spettacolare.""",
    "img2_alt":   "Gnocchi alla sorrentina gratinati in teglia di ceramica, con mozzarella filante e Parmigiano dorato e croccante in superficie",
    "prose3_h2":  "Conservazione e Varianti degli Gnocchi al Forno",
    "prose3":     """Gli gnocchi alla sorrentina si conservano in frigorifero per 2-3 giorni (nella teglia, coperta con pellicola). Per riscaldarli: forno a 180°C per 15-20 minuti coperti con stagnola, poi 5 minuti senza per ridorare la superficie. Non usare il microonde: la mozzarella diventa gommosa. Per una variante più ricca, aggiungi ricotta fresca mescolata al sugo prima di infornare: il piatto diventa cremoso e rotondo. Per una versione di carne, aggiungi polpettine di maiale nel sugo come vuole la tradizione napoletana domenicale. Gli avanzi del sugo alla sorrentina sono eccellenti come condimento per la pasta il giorno successivo.""",
    "faqs": [
      ("Posso usare i gnocchi comprati al supermercato?", "Sì — gli gnocchi confezionati freschi (trovati nel banco frigo) sono ottimi per questa ricetta. Gli gnocchi secchi funzionano bene. Per i gnocchi freschi fatti in casa consulta la nostra ricetta degli gnocchi di patate. La differenza principale è la consistenza: gli gnocchi fatti in casa sono più morbidi e leggeri, quelli confezionati tendono ad essere più compatti."),
      ("Perché i miei gnocchi alla sorrentina sono acquosi?", "Quasi sempre per due ragioni: la mozzarella non è stata sgocciolata abbastanza (metti la mozzarella su carta cucina per almeno 30 minuti) oppure il sugo era troppo liquido. Usa una passata densa o cuoci il sugo più a lungo per addensarlo. Anche cuocere gli gnocchi troppo in acqua prima del forno contribuisce all'acquosità."),
      ("Posso preparare gli gnocchi alla sorrentina in anticipo?", "Sì — assembla la teglia, coprila con pellicola e conserva in frigorifero per 12-24 ore prima di infornarla. Al momento di cuocere, aggiungi 5-10 minuti di cottura poiché gli ingredienti sono freddi. Questa è una delle ragioni per cui è un ottimo piatto da portare a casa di altri: si prepara tutto il giorno prima e si inforna all'arrivo."),
      ("Posso usare la salsa di pomodoro comprata?", "Sì, ma la qualità fa la differenza. Scegli una passata di San Marzano DOP o una marca di qualità. Evita le salse già aromatizzate — aggiungi tu aglio e basilico freschi per il sapore autentico. Cuoci comunque la salsa compraia per 10-15 minuti con aglio e olio prima di usarla: anche la passata migliora con una breve cottura."),
      ("Qual è la differenza tra gnocchi alla sorrentina e gnocchi al forno normali?", "Gli gnocchi alla sorrentina si distinguono per il sugo di San Marzano (la dolcezza del pomodoro campano è caratteristica), la mozzarella di bufala campana, e la passata in forno per la gratinatura. I 'gnocchi al forno' generici possono usare qualsiasi sugo e qualsiasi formaggio. La combinazione San Marzano + bufala campana + gnocchi di patate è la firma del piatto sorrentino."),
    ],
  },

  # ─── 31 ──────────────────────────────────────────────
  {
    "slug":        "bistecca-alla-fiorentina-ricetta",
    "title":       "Bistecca alla Fiorentina Ricetta Originale — Come Cuocerla Perfetta alla Griglia",
    "desc":        "La vera ricetta della bistecca alla fiorentina: costata di chianina alta 5cm, cotta su brace di legna a sangue, nient'altro. I segreti dei macellai toscani per la bistecca perfetta.",
    "tag":         "Secondi",
    "tag_color":   "#c62828",
    "tag_bg":      "#ffebee",
    "h1":          "Bistecca alla Fiorentina Ricetta Originale — Il Re delle Grigliate Toscane",
    "intro":       "La bistecca alla fiorentina è l'icona assoluta della cucina toscana e uno dei piatti più famosi d'Italia nel mondo. È una costata di manzo (o vitellone) con l'osso a T, alta almeno 4-5cm, pesante tra i 600g e il chilo, cotta su brace di legna viva a fuoco altissimo — sempre e solo al sangue, o al massimo rosata. Non si cuoce mai ben cotta: sarebbe un sacrilegio per qualsiasi toscano. Il condimento è di una semplicità quasi filosofica: sale grosso, pepe, olio EVO a crudo dopo la cottura e — opzionale — qualche goccia di limone. Nient'altro. La fiorentina si mangia, non si discute.",
    "prep":        "10 min", "cook": "15 min", "total": "25 min",
    "servings":    "2 porzioni", "calories": "~680", "difficulty": "Medio",
    "badge_text":  "Fiorentina",
    "cuisine":     "Italiana",
    "category":    "Secondi",
    "keywords":    "bistecca alla fiorentina ricetta originale, bistecca fiorentina come cuocerla, bistecca alla fiorentina, bistecca fiorentina chianina, come fare la fiorentina",
    "cal_num":     "680", "protein": "72g", "fat": "42g", "carbs": "0g",
    "ingredients": [
      "1 bistecca alla fiorentina con osso a T, alta 4-5cm, 600g-1kg (razza Chianina, Maremmana o Podolica idealmente)",
      "Sale grosso marino",
      "Pepe nero macinato grosso (opzionale — alcuni puristi lo escludono)",
      "Olio extravergine d'oliva toscano, a crudo",
      "Qualche goccia di limone (tradizione fiorentina, facoltativo)",
      "Rametto di rosmarino (solo per profumare il piatto, non per cuocere)",
    ],
    "steps": [
      "Tira la bistecca fuori dal frigorifero almeno 1 ora prima della cottura — deve essere a temperatura ambiente. Una bistecca fredda di frigo si cuoce in modo disomogeneo: crosta bruciata fuori, fredda dentro. Asciugala bene con carta cucina.",
      "Prepara una brace di legna viva (o carbonella di qualità) ad alta temperatura. La brace deve essere bianca in superficie e produrre calore intenso — non fiamme dirette. La distanza tra la griglia e la brace deve essere di circa 8-10cm. Scalda la griglia sul fuoco per almeno 5 minuti prima di mettere la bistecca.",
      "Posa la bistecca sulla griglia caldissima senza niente — niente olio, niente sale. Lasciala cuocere SENZA TOCCARLA per 4-5 minuti sul primo lato. Non spostarla, non girarla, non bucarla. La carne si staccherà naturalmente dalla griglia quando è pronta per essere girata.",
      "Gira la bistecca — un solo passaggio — e cuoci 4-5 minuti sull'altro lato. La regola classica toscana è 'un minuto per centimetro di spessore per lato'. Per una bistecca di 5cm: 5 minuti per lato.",
      "Metti la bistecca in piedi sull'osso per 2-3 minuti: il calore cuoce anche il centro vicino all'osso che rimane sempre più raro. Questo passaggio è fondamentale per una cottura omogenea.",
      "Togli la bistecca dalla griglia. Sala subito con sale grosso su entrambi i lati — il sale si scioglie nel calore residuo della carne. Lascia riposare 3-5 minuti su un tagliere, non in un piatto (il piatto accumula il sangue — il tagliere lo fa circolare). Prima di servire, un filo d'olio EVO toscano a crudo, pepe se gradito, e qualche goccia di limone.",
    ],
    "tips": [
      "Temperatura ambiente: tira la bistecca dal frigo 1 ora prima — fondamentale.",
      "Mai bucare con la forchetta durante la cottura: perdi i succhi che danno sapore.",
      "Sale solo dopo la cottura: il sale in anticipo estrae l'acqua e impedisce la formazione della crosta.",
      "Al sangue sempre: la fiorentina ben cotta è un errore, non una preferenza.",
    ],
    "prose1_h2":  "La Chianina: Il Manzo della Bistecca alla Fiorentina Originale",
    "prose1":     """La bistecca alla fiorentina originale si fa con la Chianina — una razza bovina autoctona della Val di Chiana (Toscana e Umbria), una delle più antiche d'Europa. La Chianina produce carne magra, tenera e di sapore intenso, con una marmorizzazione fine che si scioglie durante la cottura. La bistecca alla fiorentina ha ottenuto l'IGP (Indicazione Geografica Protetta) per la Chianina, la Maremmana e la Podolica toscana. Fuori dalla Toscana, la fiorentina viene spesso proposta con carni di altri tagli o razze — perfettamente buona, ma tecnicamente non 'fiorentina'. Quando scegli la carne, cerca costata con osso a T (che include il filetto su un lato e il controfiletto sull'altro), maturata (frollata) almeno 20-30 giorni per tenerezza e sapore.""",
    "prose2_h2":  "Al Sangue, Rosata o Ben Cotta? La Risposta Toscana è Una Sola",
    "prose2":     """In Toscana, la risposta alla domanda sulla cottura della fiorentina è unanime: al sangue (inglese: rare). La temperatura interna ideale è 50-52°C al cuore. Rosata (medium-rare, 55-57°C) è accettata dai più moderni. Oltre i 60°C — ben cotta — la carne perde succhi, sapore e tenerezza in modo irreversibile. C'è un detto fiorentino: 'La fiorentina si deve lamentare nel piatto' — riferendosi al leggero sfrigolio dei succhi rosati quando la carne calda incontra il piatto. Se ordini la fiorentina ben cotta in un ristorante toscano, non stupirti se il cameriere ti guarda con disappunto.""",
    "img2_alt":   "Bistecca alla fiorentina su brace di legna con crosticina bruna perfetta, ancora al sangue al cuore, su tagliere di legno",
    "prose3_h2":  "Come Scegliere la Fiorentina dal Macellaio e Come Conservarla",
    "prose3":     """Dal macellaio: chiedi la costata con osso a T, alta almeno 4cm (meglio 5-6cm), con marmorizzazione visibile nel grasso intramuscolare. La carne deve essere di un rosso scuro e profondo — non rosso brillante (segnale di carne fresca non frollata). Chiedi se è stata frollata: una frollatura di 20-30 giorni rende la carne incomparabilmente più tenera e saporita. A casa: conserva la fiorentina coperta con carta da macellaio (non pellicola) in frigorifero fino a 3-4 giorni. Tira fuori 1 ora prima. Non congelare una fiorentina di qualità se puoi evitarlo: lo scongelamento altera la struttura delle fibre. Se devi congelare, fallo immediatamente dopo l'acquisto e scongela lentamente in frigorifero per 24 ore.""",
    "faqs": [
      ("Qual è il peso corretto di una bistecca alla fiorentina?", "La tradizione vuole una bistecca di almeno 600g (con l'osso) — solitamente tra i 700g e il chilo. Le versioni più grandi (fino a 1,5kg) si trovano nelle macellerie storiche fiorentine. La bistecca si condivide tra 2 persone, tagliata a fette spesse sul tagliere dopo il riposo. Non si serve mai in porzione individuale: è un piatto conviviale."),
      ("Posso cucinare la fiorentina sul barbecue a gas invece del carbone?", "Sì, ma il sapore è leggermente diverso. La brace di legna di quercia o di ulivo dà un aroma affumicato inimitabile. Il gas è più pratico e la cottura è ottima. L'importante è l'alta temperatura: scalda il barbecue a gas al massimo per 15 minuti prima di mettere la carne. Anche una padella in ghisa caldissima funziona in casa — non dà la stessa crosta della griglia a fuoco diretto, ma il risultato è molto buono."),
      ("Quando si aggiunge il sale alla fiorentina?", "Il sale si aggiunge DOPO la cottura, non prima. Il sale in anticipo estrae l'umidità dalla carne e impedisce la formazione della crosta bruna caratteristica (reazione di Maillard). Sala con sale grosso immediatamente dopo aver tolto la bistecca dalla griglia, mentre è ancora caldissima: il calore scioglie il sale e lo distribuisce nella carne."),
      ("La bistecca alla fiorentina deve per forza essere al sangue?", "Per i toscani sì — è non negoziabile. La temperatura interna ideale è 50-52°C al cuore (al sangue). Puoi cucinarla rosata (55-57°C, medium-rare) se preferisci. Oltre i 60°C la carne perde sapore e tenerezza irrimediabilmente. Detto questo: cucina la carne come preferisci. Ma sappi che la fiorentina al sangue è il piatto toscano; quella ben cotta è un'altra cosa."),
      ("Quanto deve frollare una bistecca alla fiorentina?", "Una buona fiorentina dovrebbe essere frollata (dry-aged) almeno 20-30 giorni. La frollatura rompe gli enzimi muscolari, rendendo la carne più tenera e concentrando il sapore. Le versioni frollate 45-60 giorni sono considerate premium, con un sapore intensissimo quasi nocciolato. Chiedi al tuo macellaio di fiducia: se lavora bene, ha carne frollata sempre disponibile."),
    ],
  },

  # ─── 32 ──────────────────────────────────────────────
  {
    "slug":        "cannoli-siciliani-ricetta",
    "title":       "Cannoli Siciliani Ricetta Originale — Il Dolce Siciliano più Famoso al Mondo",
    "desc":        "La vera ricetta dei cannoli siciliani fatti in casa: scorza croccante fritta e crema di ricotta di pecora con gocce di cioccolato. I segreti dei pasticceri palermitani per cannoli perfetti.",
    "tag":         "Dolci",
    "tag_color":   "#6a1b9a",
    "tag_bg":      "#f3e5f5",
    "h1":          "Cannoli Siciliani Ricetta Originale — La Vera Ricetta della Pasticceria Siciliana",
    "intro":       "Il cannolo siciliano è forse il dolce italiano più riconoscibile al mondo: una scorza croccante e bollosa fritta nello strutto, ripiena al momento di una crema di ricotta di pecora setosa, arricchita da gocce di cioccolato fondente, scorza d'arancia candita e pistacchi di Bronte. La parola 'cannolo' deriva dal latino 'canna' — il tubo di canna su cui l'impasto veniva avvolto e fritto. Le origini sono arabe-normanne, legate alla Sicilia medievale. Oggi il cannolo è simbolo di Palermo, della Sicilia, e dell'identità culinaria italiana nel mondo. Farlo in casa è possibile — e il risultato è incomparabilmente più buono di qualsiasi cannolo confezionato.",
    "prep":        "40 min", "cook": "20 min", "total": "1h",
    "servings":    "12 cannoli", "calories": "~260", "difficulty": "Medio",
    "badge_text":  "Cannoli",
    "cuisine":     "Siciliana",
    "category":    "Dolci",
    "keywords":    "cannoli siciliani ricetta originale, cannoli siciliani fatti in casa, ricetta cannoli siciliani, crema ricotta cannoli, scorza cannoli croccante",
    "cal_num":     "260", "protein": "8g", "fat": "13g", "carbs": "28g",
    "ingredients": [
      "250g farina 00",
      "30g strutto (o burro freddo a cubetti)",
      "1 uovo intero",
      "30g zucchero semolato",
      "30ml vino Marsala secco (o vino bianco secco)",
      "1 cucchiaino cacao amaro in polvere",
      "½ cucchiaino cannella in polvere",
      "1 pizzico di sale",
      "1 albume (per sigillare le scorze)",
      "Olio di semi di girasole o strutto per friggere (abbondante)",
      "500g ricotta di pecora freschissima (ben sgocciolata 12 ore in frigorifero)",
      "150g zucchero a velo setacciato",
      "80g gocce di cioccolato fondente",
      "Scorza d'arancia candita a cubetti (per decorare)",
      "Granella di pistacchi di Bronte (per decorare)",
      "Zucchero a velo (per spolverare)",
    ],
    "steps": [
      "Prepara l'impasto delle scorze: metti la farina a fontana, aggiungi strutto, uovo, zucchero, Marsala, cacao, cannella e sale. Impasta energicamente per 8-10 minuti fino a ottenere un impasto liscio, sodo ed elastico. Avvolgi in pellicola e fai riposare in frigorifero per almeno 30 minuti (meglio 1 ora). Il riposo è fondamentale per la croccantezza delle scorze.",
      "Prepara la crema di ricotta: metti la ricotta di pecora sgocciolata in un colino a maglie fini sopra una ciotola, copri con pellicola e lascia in frigorifero per almeno 12 ore (meglio 24) a perdere tutto il siero. Poi setacciaIa con un passino per ottenere una crema liscia e senza grumi. Aggiungi zucchero a velo, mescola con una spatola e aggiungi le gocce di cioccolato fondente. Riponi in frigorifero fino all'uso.",
      "Stendi l'impasto delle scorze con il mattarello o la macchina per la pasta fino a uno spessore di 1-2mm (lo strato deve essere sottilissimo — è il segreto della croccantezza). Ritaglia dei dischi o ovali di circa 10-12cm di diametro.",
      "Avvolgi ogni disco di pasta intorno ai tubi di metallo per cannoli (cannoli forms), ungendo leggermente i tubi con olio. Sigilla la chiusura con un pochino d'albume sbattuto, premendo bene. La giuntura deve essere ben chiusa o si aprirà durante la frittura.",
      "Scalda abbondante olio di semi (o strutto) in un tegame capiente a 175-180°C. Friggi i cannoli sui tubi, pochi alla volta, rigirando spesso, per 2-3 minuti fino a ottenere una doratura uniforme e le caratteristiche bolle sulla superficie. Le bolle sono il segno di un impasto e una frittura corretti.",
      "Scola i cannoli su carta assorbente. Dopo 1-2 minuti (quando non bruciano più) estrai delicatamente i tubi ruotandoli: fai una leggera pressione al centro della scorza mentre ruoti il tubo verso di te. Lascia raffreddare completamente le scorze prima di riempirle — mai riempire le scorze ancora calde.",
      "Riempi i cannoli SOLO al momento di servire: usa una sac-à-poche con bocchetta liscia e riempi da entrambe le estremità. Decora le estremità con un'arancia candita e granella di pistacchi. Spolvera con zucchero a velo. Non riempire mai i cannoli in anticipo — la scorza deve restare croccante.",
    ],
    "tips": [
      "Sgocciola la ricotta 12-24 ore: l'umidità in eccesso rende la crema liquida e bagna le scorze.",
      "Impasto sodo e riposato: la consistenza dell'impasto e il riposo in frigo determinano la croccantezza.",
      "Riempi solo all'ultimo momento: anche 30 minuti bastano a inzuppare la scorza.",
      "Bolle sulla scorza = frittura corretta: se non ci sono bolle, l'olio non era abbastanza caldo.",
    ],
    "prose1_h2":  "Le Origini Arabe del Cannolo Siciliano e la Ricotta di Pecora",
    "prose1":     """Il cannolo siciliano ha origini antichissime che si intrecciano con la storia della Sicilia medievale. Secondo la tradizione storica più accreditata, il dolce nacque a Caltanissetta — 'Kalt el Nissà' in arabo, 'castello delle donne' — durante la dominazione araba (827-1072 d.C.). Le donne dell'harem del principe saraceno avrebbero inventato un dolce fritto ripieno di ricotta dolce per celebrare il Carnevale. La ricetta poi si diffuse nei conventi di clausura siciliani, dove le suore erano le maestre indiscusse della pasticceria. La ricotta di pecora è l'ingrediente imprescindibile: non di mucca, non di bufala. La ricotta di pecora siciliana ha un sapore più intenso, una grassezza che rende la crema sontuosa, e una dolcezza naturale che si sposa perfettamente con lo zucchero a velo e il cioccolato fondente.""",
    "prose2_h2":  "Scorza Croccante e Bolle: i Segreti della Frittura Perfetta",
    "prose2":     """Le 'bolle' che caratterizzano la scorza del cannolo autentico non sono un difetto ma il segno di un impasto e una frittura eseguiti correttamente. Si formano quando l'impasto contiene la giusta quantità di grasso (strutto, non burro — lo strutto dà croccantezza più a lungo) e quando l'olio di frittura è a temperatura precisa: 175-180°C. Al di sotto di questa temperatura la scorza assorbe olio invece di croccantizzarsi. Lo strutto — spesso sostituito dal burro nelle versioni moderne — era l'ingrediente tradizionale per la frittura stessa. Per uno strato sottilissimo e uniforme di pasta, la macchina per la pasta è più affidabile del mattarello: porta l'impasto fino al penultimo livello di spessore (mai l'ultimo, troppo sottile per la manipolazione). L'impasto deve contenere anche il cacao: non per dare sapore di cioccolato, ma per il colore scuro caratteristico della scorza autentica palermitana.""",
    "img2_alt":   "Cannoli siciliani ripieni di crema di ricotta con gocce di cioccolato, arancia candita e granella di pistacchi di Bronte su vassoio bianco",
    "prose3_h2":  "Conservazione dei Cannoli e Varianti Regionali",
    "prose3":     """Le scorze vuote si conservano a temperatura ambiente in un contenitore ermetico per 5-7 giorni — mantengono la croccantezza. La crema di ricotta si conserva in frigorifero coperta per 2-3 giorni. I cannoli già riempiti vanno consumati entro 30-60 minuti: anche il frigorifero ammorbidisce rapidamente la scorza. Varianti regionali: a Palermo si usa la ricotta di pecora pura, le gocce di cioccolato fondente e l'arancia candita. A Catania si aggiunge la scorza di limone candito al posto dell'arancia. A Messina la crema è spesso arricchita con crema di pistacchi. La versione di Piana degli Albanesi (PA) è considerata l'originale storico — usano ricotta freschissima lavorata la mattina stessa. Per una versione moderna, sostituisci una parte della ricotta con mascarpone: la crema risulta più densa e si mantiene meglio nelle scorze.""",
    "faqs": [
      ("Posso usare la ricotta di mucca invece di pecora?", "Tecnicamente sì, ma il risultato è diverso. La ricotta di pecora ha più grasso, più sapore e una consistenza più densa che dà alla crema cannoli la sua ricchezza caratteristica. La ricotta di mucca produce una crema più delicata e meno saporita. Se usi ricotta di mucca, aggiungila mascarpone (50/50) per avvicinarti alla consistenza originale. In ogni caso, la sgocciolatura è fondamentale: anche la ricotta di mucca deve perdere tutto il siero."),
      ("Perché le mie scorze non fanno le bolle?", "Le bolle si formano quando: 1) l'impasto è stato lavorato correttamente (abbastanza glutine sviluppato), 2) la pasta è molto sottile (1-2mm), 3) l'olio è a 175-180°C. Se non ci sono bolle, l'olio era probabilmente troppo freddo o il mastrello troppo spesso. Usa un termometro da cucina per monitorare la temperatura dell'olio."),
      ("Posso preparare la crema di cannoli il giorno prima?", "Sì — la crema di ricotta migliora riposando in frigorifero per 12-24 ore (si compatta e i sapori si amalgamano). Copri con pellicola a contatto per evitare che assorba odori dal frigorifero. Rimescola bene prima di usarla. Le scorze vuote si conservano a temperatura ambiente in scatola chiusa. Riempi SOLO al momento di servire."),
      ("Dove compro i tubi per cannoli?", "I tubi di metallo (cannoli forms) si trovano online, nelle ferramenta attrezzate o nei negozi di articoli per pasticceria. Diametro standard: 2cm, lunghezza 12-14cm. In alternativa, puoi usare dei pezzi di canna da bambino (la tradizione originale) o costruire tubi con carta stagnola arrotolata stretta. I tubi di metallo sono la soluzione più pratica e riutilizzabile."),
      ("La crema di ricotta deve essere setacciata?", "Sì — è il passaggio che fa la differenza tra una crema liscia e setosa e una granulosa. Passa la ricotta sgocciolata attraverso un colino a maglie fini (o un passaverdure) prima di aggiungere lo zucchero. La setacciatura elimina i grumi e areaa leggermente la crema. Alcuni pasticceri siciliani usano il frullatore a immersione per 10 secondi — funziona ma rende la crema leggermente più liquida."),
    ],
  },

  # ─── 33 ──────────────────────────────────────────────
  {
    "slug":        "pasta-al-forno-ricetta",
    "title":       "Pasta al Forno Ricetta della Nonna — La Pasta Gratinata più Buona d'Italia",
    "desc":        "La vera ricetta della pasta al forno napoletana della nonna: rigatoni al sugo con polpettine, mozzarella filante, uova sode e salame. Il piatto della domenica italiana per eccellenza.",
    "tag":         "Primi",
    "tag_color":   "#b71c1c",
    "tag_bg":      "#ffebee",
    "h1":          "Pasta al Forno Ricetta della Nonna — Il Piatto della Domenica Napoletana",
    "intro":       "La pasta al forno è il re della tavola domenicale italiana. Non una ricetta ma una tradizione — ogni famiglia ha la sua versione, tramandata di generazione in generazione con varianti regionali che riflettono la storia gastronomica d'Italia. La versione napoletana, la più celebre, è una celebrazione: rigatoni (o ziti spezzati) al sugo ricco di San Marzano, con polpettine di maiale fritte, mozzarella di bufala filante, uova sode, salame napoletano, e uno strato di Parmigiano Reggiano dorato che forma la crosta gratinata irresistibile. È il piatto che profuma tutta la casa di domenica mattina, che si prepara il giorno prima, che unisce famiglie intere intorno al tavolo.",
    "prep":        "30 min", "cook": "45 min", "total": "1h 15min",
    "servings":    "6 porzioni", "calories": "~580", "difficulty": "Medio",
    "badge_text":  "Domenica",
    "cuisine":     "Napoletana",
    "category":    "Primi",
    "keywords":    "pasta al forno ricetta, pasta al forno napoletana, pasta al forno della nonna, pasta gratinata al forno, pasta al forno con polpette",
    "cal_num":     "580", "protein": "28g", "fat": "24g", "carbs": "62g",
    "ingredients": [
      "500g rigatoni (o ziti spezzati, o penne rigate)",
      "700ml passata di pomodoro San Marzano",
      "2 spicchi d'aglio",
      "Olio extravergine d'oliva",
      "Sale, pepe, basilico fresco",
      "300g macinato di maiale (o misto manzo-maiale) per le polpettine",
      "1 uovo (per le polpette)",
      "2 cucchiai Parmigiano Reggiano grattugiato (per le polpette)",
      "Prezzemolo, sale, pepe (per le polpette)",
      "300g mozzarella di bufala (o fiordilatte), sgocciolata e tagliata a dadini",
      "3 uova sode, sbucciate e tagliate a fette",
      "150g salame napoletano (o salame piccante), a dadini",
      "100g Parmigiano Reggiano DOP grattugiato",
      "Olio di semi per friggere le polpettine",
    ],
    "steps": [
      "Prepara le polpettine: mescola il macinato con l'uovo, il Parmigiano, il prezzemolo tritato, sale e pepe. Forma palline piccole (2cm di diametro) — più piccole del solito perché devono cuocere di nuovo in forno. Friggi in olio di semi abbondante a 170°C per 3-4 minuti fino a doratura uniforme. Scola su carta assorbente. Le polpettine si friggono senza farina: la superficie croccante si forma naturalmente nel calore dell'olio.",
      "Prepara il sugo: soffriggi l'aglio in olio EVO, aggiungi la passata di San Marzano, sale e basilico. Cuoci a fuoco medio per 20-25 minuti fino a ottenere un sugo denso e saporito. Il sugo deve essere più concentrato del solito perché deve condire sia la pasta che reggere la cottura in forno senza diventare acquoso. Togli l'aglio.",
      "Cuoci la pasta in abbondante acqua salata ma toglila 3-4 minuti prima del tempo indicato sulla confezione: deve essere molto al dente, quasi cruda al centro. Scolala e condiscila con metà del sugo caldo, mescolando bene per evitare che si attacchi.",
      "Preriscalda il forno a 200°C statico. Imburra o olea una teglia da forno capiente (28x35cm circa). Stendi un mestolo di sugo sul fondo della teglia.",
      "Assembla la pasta al forno a strati: versa metà dei rigatoni conditi, distribuisci le polpettine, metà della mozzarella, le uova sode a fette, il salame a dadini, metà del Parmigiano e qualche cucchiaiata di sugo. Aggiungi il secondo strato di pasta, il sugo rimanente, la mozzarella restante e abbondante Parmigiano Reggiano in strato generoso sulla superficie.",
      "Copri la teglia con stagnola e inforna per 25 minuti. Poi rimuovi la stagnola e cuoci altri 15-20 minuti a 220°C (o con grill acceso) fino a ottenere una crosticina dorata e croccante in superficie e i bordi borbottanti. Lascia riposare 10 minuti prima di tagliare e servire — come la lasagna, riposa sempre meglio.",
    ],
    "tips": [
      "Pasta al dente prima del forno: cuoci 4 minuti meno del tempo indicato o si spappola in forno.",
      "Sugo denso: il sugo acquoso rende la pasta molle. Restringilo bene o scola la pasta perfettamente.",
      "Mozzarella sgocciolata: l'acqua della mozzarella rende il piatto acquoso. Sgocciola almeno 1 ora.",
      "Riposa 10 minuti: dopo il forno la pasta si compatta — si taglia meglio e i sapori si fondono.",
    ],
    "prose1_h2":  "La Pasta al Forno della Domenica Napoletana: Storia e Tradizione",
    "prose1":     """La pasta al forno è il simbolo della cucina domenicale napoletana — il piatto che identifica il pranzo in famiglia, il sugo che cuoce tutta la mattina, il profumo che impregna il palazzo intero. Nella tradizione napoletana originale, la pasta al forno si preparava il sabato sera: si assemblava la teglia cruda e si conservava in frigorifero per infornarla la domenica mattina mentre la famiglia si preparava per la messa. Gli ingredienti del ripieno variavano secondo la disponibilità e la stagione: le polpettine (chiamate 'purpetiello' in napoletano), le uova sode, il salame, la mozzarella e il Parmigiano erano fissi. Alcune famiglie aggiungevano ricotta salata, altri la provola affumicata. La variante siciliana usa l'anelletti (pasta ad anello) ed è un'altra preparazione dalla storia ugualmente ricca.""",
    "prose2_h2":  "Quale Pasta Usare per la Pasta al Forno? Ziti, Rigatoni o Penne?",
    "prose2":     """La pasta della tradizione napoletana è gli ziti spezzati: i lunghi ziti di pasta di Gragnano vengono rotti a mano in pezzi irregolari di 4-5cm. L'irregolarità dei pezzi crea sacche che trattengono il sugo e la crema di formaggio in modo più efficace rispetto alla pasta tagliata con precisione. I rigatoni sono l'alternativa più pratica e diffusa: il formato rigato trattiene il sugo e le righe sulla superficie si gratinano meravigliosamente. Le penne rigate funzionano bene. Evita la pasta liscia (senza righe) e i formati troppo piccoli (maccheroni, ditali): tendono a creare un impasto omogeneo invece degli strati distinti. La pasta deve essere di Gragnano IGP se vuoi il risultato migliore: regge la doppia cottura (acqua + forno) senza spappolarsi.""",
    "img2_alt":   "Pasta al forno napoletana gratinata appena sfornata, con crosticina dorata e croccante, mozzarella filante e polpettine visibili nel taglio",
    "prose3_h2":  "Come Preparare la Pasta al Forno in Anticipo e Come Conservarla",
    "prose3":     """La pasta al forno è uno dei piatti più adatti alla preparazione anticipata: assembla la teglia il giorno prima, copri con pellicola e conserva in frigorifero. Il giorno del pranzo, togli dal frigo 30 minuti prima di infornare (per ridurre lo shock termico) e cuoci come da ricetta aggiungendo 10 minuti in più. La pasta al forno avanzata si conserva in frigorifero per 2-3 giorni e si riscalda meravigliosamente: copri con stagnola, forno a 180°C per 20 minuti, poi grill per 5 minuti per ridorare la superficie. Puoi anche congelare porzioni singole già cotte: scongela in frigorifero e riscalda in forno. Il giorno dopo è ancora più buona — i sapori si fondono con il riposo. Una variante leggera: sostituisci le polpettine con salsiccia di maiale sbriciolata e soffritta, e usa la besciamella al posto di parte del sugo per una pasta al forno più cremosa e ricca.""",
    "faqs": [
      ("Posso fare la pasta al forno senza polpette?", "Sì — la versione 'essenziale' usa solo sugo, mozzarella, salame e Parmigiano. Puoi sostituire le polpette con salsiccia sbriciolata sofritta, prosciutto cotto a dadini, o semplicemente aumentare la mozzarella e il Parmigiano per una versione vegetariana (senza salumi). La pasta al forno con besciamella (senza sugo di pomodoro) è ottima per chi preferisce una versione più delicata."),
      ("Perché la mia pasta al forno viene acquosa?", "Le cause principali: 1) La mozzarella non è stata sgocciolata abbastanza — metti i dadini di mozzarella su carta cucina per 1-2 ore. 2) Il sugo era troppo liquido — restringilo di più o usa la passata senza aggiungere acqua. 3) La pasta era cotta troppo in anticipo e ha rilasciato amido — condisci la pasta con il sugo solo quando stai assemblando la teglia."),
      ("Posso usare la pasta avanzata del giorno prima?", "Sì — è una delle versioni più gustose. Se hai pasta condita avanzata, aggiungila nella teglia con mozzarella, Parmigiano e qualche cucchiaiata di sugo fresco. Copri con stagnola e inforna 25 minuti, poi dorata senza stagnola. Il sapore della pasta 'ricicla' è spesso più ricco perché la pasta ha assorbito il sugo."),
      ("Devo coprire la pasta al forno con la stagnola?", "Sì, per i primi 25 minuti: la stagnola intrappola il vapore che scioglie la mozzarella e riscalda uniformemente la pasta. Negli ultimi 15-20 minuti rimuovi la stagnola: è la fase che crea la crosticina gratinata e dorata in superficie. Senza stagnola per tutta la cottura, la pasta in superficie si secca prima che l'interno si scaldi."),
      ("Ziti o rigatoni: quale pasta è migliore per la pasta al forno?", "Gli ziti spezzati di Gragnano sono la scelta tradizionale napoletana: la pasta di Gragnano reggeva la doppia cottura meglio di qualsiasi altra. I rigatoni sono più pratici e ugualmente ottimi — il formato rigato trattiene il sugo perfettamente. L'importante è usare pasta di qualità (Gragnano IGP o pasta di semola di grano duro di qualità) e cuocerla molto al dente prima del forno."),
    ],
  },

  # ─── 34 ──────────────────────────────────────────────
  {
    "slug":        "crostata-di-marmellata-ricetta",
    "title":       "Crostata di Marmellata Ricetta della Nonna — La Torta Italiana più Amata",
    "desc":        "La vera ricetta della crostata di marmellata con pasta frolla della nonna: friabile, burrosa, con il reticolo dorato perfetto. La torta italiana classica che non stanca mai.",
    "tag":         "Dolci",
    "tag_color":   "#e65100",
    "tag_bg":      "#fff3e0",
    "h1":          "Crostata di Marmellata Ricetta della Nonna — La Pasta Frolla Friabile Perfetta",
    "intro":       "La crostata di marmellata è la torta italiana per eccellenza: semplice, profumata, con la pasta frolla burrosa e friabile che si scioglie in bocca e il ripieno di marmellata che caramella leggermente in forno. È la torta delle colazioni italiane, dei compleanni in famiglia, dei fine pasto improvvisati — quella che ogni nonna italiana sa fare con gli occhi chiusi. La pasta frolla perfetta non è difficile, ma richiede rispetto di alcune regole fondamentali: burro freddo, lavorazione rapida, riposo in frigorifero, cottura a temperatura giusta. Seguile e otterrai una crostata con il reticolo dorato, i bordi croccanti e un ripieno che non cola mai.",
    "prep":        "25 min", "cook": "35 min", "total": "1h",
    "servings":    "8 porzioni", "calories": "~340", "difficulty": "Facile",
    "badge_text":  "Crostata",
    "cuisine":     "Italiana",
    "category":    "Dolci",
    "keywords":    "crostata di marmellata ricetta, crostata della nonna ricetta originale, pasta frolla per crostata, crostata marmellata albicocche, ricetta crostata italiana",
    "cal_num":     "340", "protein": "5g", "fat": "15g", "carbs": "46g",
    "ingredients": [
      "300g farina 00 (o farina debole per dolci)",
      "150g burro freddo a cubetti (qualità ottima — si sente)",
      "120g zucchero a velo (o semolato fine)",
      "2 tuorli d'uovo freschi (a temperatura ambiente)",
      "1 uovo intero (a temperatura ambiente)",
      "Scorza grattugiata di 1 limone biologico",
      "1 pizzico di sale",
      "½ cucchiaino estratto di vaniglia",
      "400g marmellata di albicocche (o fragole, amarene, lamponi — qualità artigianale)",
      "1 tuorlo + 1 cucchiaio di latte (per lucidare il reticolo)",
    ],
    "steps": [
      "Prepara la pasta frolla con il metodo sabbiato: metti la farina setacciata in una ciotola, aggiungi il burro freddo a cubetti e lavora velocemente con le dita (o nella planetaria con gancio a foglia) fino a ottenere un composto sabbioso, come briciole di pane. Il burro non deve scaldarsi: mani fredde, lavoro rapido. Questo è il segreto della frolla friabile.",
      "Aggiungi zucchero a velo, scorza di limone, sale, vaniglia e i tuorli (più l'uovo intero). Impasta brevemente — giusto il tempo di compattare l'impasto. Non lavorare troppo: il glutine in eccesso rende la frolla elastica invece che friabile. Appena l'impasto si compatta, smetti. Forma un disco, avvolgi in pellicola e riposa in frigorifero per almeno 30 minuti (meglio 1 ora). L'impasto freddo è fondamentale per stenderlo senza che si rompa.",
      "Preriscalda il forno a 175°C statico. Imburra e infarina uno stampo per crostata da 24-26cm (o usa carta forno). Tira fuori la pasta frolla dal frigo e lasciala temperare 5 minuti. Dividi l'impasto: tieni ⅓ per il reticolo, usa ⅔ per la base.",
      "Stendi la base di frolla su un piano leggermente infarinato a uno spessore di 4-5mm. Arrotola delicatamente sulla frolla sul mattarello e adagiala sullo stampo imburrato. Premi bene lungo i bordi e il fondo. Elimina l'eccesso di pasta passando il mattarello sui bordi dello stampo. Punzecchia il fondo con una forchetta (evita le bolle in cottura).",
      "Scalda la marmellata in un pentolino a fuoco basso mescolando per 2 minuti: diventa più fluida e si stende uniformemente. Versala sulla base di frolla e distribuiscila in modo uniforme, lasciando 1cm di bordo libero. Non mettere troppa marmellata: uno strato di 5-7mm è sufficiente.",
      "Stendi il ⅓ di frolla rimasto a 3mm di spessore. Taglia strisce di 1,5-2cm di larghezza con una rotella dentata (o un coltello). Disponi le strisce sul ripieno in modo incrociato a formare il reticolo classico. Premi le estremità sui bordi. Spennella il reticolo con il tuorlo mescolato al latte per una doratura lucida.",
      "Inforna per 30-35 minuti fino a quando la pasta frolla è dorata e i bordi leggermente bruni. La marmellata visibile tra le strisce deve essere borbottante e caramellata. Lascia raffreddare completamente nel stampo prima di sformare — la crostata calda si rompe facilmente.",
    ],
    "tips": [
      "Burro freddo sempre: il burro caldo rende la frolla elastica e dura. Usa il burro appena tolto dal frigo.",
      "Non impastare troppo: la frolla si lavora il meno possibile — giusto il tempo di compattarsi.",
      "Marmellata di qualità: usa una marmellata artigianale densa. Le marmellate economiche acquose colano durante la cottura.",
      "Lascia raffreddare completamente: la crostata calda è morbida e si rompe — aspetta almeno 1 ora.",
    ],
    "prose1_h2":  "Storia della Crostata Italiana e le Varianti Regionali",
    "prose1":     """La crostata è uno dei dolci più antichi della tradizione italiana, con origini che risalgono al Rinascimento. La prima ricetta documentata appare nel 'Libro de Arte Coquinaria' di Maestro Martino da Como (1465 circa), già con una struttura simile all'attuale: pasta frolla, ripieno di frutta o marmellata, copertura a griglia. Nel Settecento e Ottocento la crostata si codifica nella forma attuale grazie ai pasticceri romani e napoletani. Ogni regione italiana ha la sua variante: la crostata di ricotta (romana) con crema di ricotta e visciole; la crostata di fragole (toscana) con crema pasticcera e fragole fresche; la crostata di mele (altoatesina) con mele, cannella e chiodi di garofano; la 'linzer torte' (friulana-austriaca) con pasta alle mandorle e ribes. La crostata di marmellata 'bianca' — pasta frolla senza reticolo, solo uno strato di marmellata — si chiama 'tronchetto' in alcune zone d'Italia.""",
    "prose2_h2":  "Pasta Frolla: Metodo Classico vs Metodo Sabbiato — Qual è la Differenza?",
    "prose2":     """Esistono due scuole di pensiero per la pasta frolla: il metodo classico (crema) e il metodo sabbiato. Nel metodo classico si monta prima burro e zucchero (come per un impasto montato), poi si aggiungono uova e infine la farina. Il risultato è una frolla morbida, poco friabile, adatta a tartellette e biscotti da decorare. Nel metodo sabbiato (il preferito per la crostata) si parte dalla farina e il burro freddo: si 'sabbia' il grasso nella farina prima di aggiungere gli ingredienti umidi. Il risultato è una frolla più friabile, più delicata, che si spezza alla pressione delle dita — la frolla della crostata della nonna. Il trucco del burro freddo: il grasso non deve sciogliersi durante la lavorazione. Le mani calde rovinano la frolla. Se lavori in estate o in una cucina calda, fai riposare l'impasto in freezer per 15 minuti invece che in frigo.""",
    "img2_alt":   "Crostata di marmellata di albicocche appena sfornata con reticolo di pasta frolla dorata e croccante su piatto di ceramica bianca",
    "prose3_h2":  "Quale Marmellata Usare e Come Conservare la Crostata",
    "prose3":     """La scelta della marmellata fa la differenza. Le marmellate più adatte alla crostata sono quelle con frutta ad alto contenuto di pectina (che aiuta a mantenere la compattezza in cottura): albicocche, prugne, visciole, amarene. Le marmellate di fragole o lamponi sono più liquide e tendono a colare — riscaldandole prima di usarle (come indicato nei passi) si concentrano e migliorano. Usa sempre marmellate di qualità artigianale con alta percentuale di frutta (60%+): le versioni economiche contengono troppa acqua e zucchero, si liquefano in forno e rendono la base molle. La marmellata biologica ha spesso più frutta e meno additivi. Conservazione: la crostata si conserva a temperatura ambiente (su un piatto, coperta con campana o pellicola lenta) per 3-4 giorni. In frigorifero si conserva 5-6 giorni ma la frolla perde friabilità. Per il massimo della croccantezza, consuma entro 2 giorni.""",
    "faqs": [
      ("Posso usare il burro salato per la pasta frolla?", "Sì, ma riduci o elimina il pizzico di sale dalla ricetta. Il burro salato dà una nota interessante alla frolla che bilancia la dolcezza della marmellata. In Francia è la norma per la pâte brisée sucrée. In Italia la tradizione usa burro non salato, ma il burro salato funziona bene — specialmente con marmellate molto dolci come quella di albicocche."),
      ("Perché la mia pasta frolla si rompe quando la stendo?", "Cause: 1) L'impasto era troppo freddo — lascialo a temperatura ambiente 5-10 minuti prima di stenderlo. 2) Era troppo secco — aggiungi qualche goccia d'acqua fredda la prossima volta. 3) Era stato lavorato troppo — il glutine sviluppato eccessivamente rende la frolla elastica e difficile da stendere. Soluzione rapida: compatta i pezzi rotti con le mani e rimetti in frigo 10 minuti."),
      ("Posso preparare la pasta frolla il giorno prima?", "Sì — la pasta frolla migliora riposando in frigorifero 24 ore. Avvolta nella pellicola si conserva 3 giorni in frigorifero e 1 mese in freezer. Per usarla dopo il freezer, scongela in frigorifero per 12 ore. La frolla riposata è più facile da stendere e più friabile dopo la cottura."),
      ("Perché la mia marmellata cola durante la cottura?", "Cause: 1) La marmellata era troppo liquida — scalda sempre la marmellata prima di usarla per concentrarla. 2) Ne hai messa troppa — uno strato di 5-7mm è il massimo. 3) La frolla aveva buchi o era troppo sottile lungo i bordi. Per sicurezza, aggiungi 1 cucchiaino di maizena alla marmellata calda — addensa ulteriormente e non cola."),
      ("Con quali marmellate funziona meglio la crostata?", "Le classiche italiane: albicocche (la più usata — dolce, con acidità leggera), visciole (la preferita romana — aspra e profonda), fragole (visivamente bella, più liquida), amarene (intensa, perfetta con la frolla burrosa). Per versioni moderne: lamponi (acidità elegante), fico (dolce e mielosa), arancia amara (marmelata classica inglese — funziona sorprendentemente bene). Evita le marmellate troppo dolci senza acidità: la frolla burrosa ha bisogno di un contrasto acido per equilibrio."),
    ],
  },

  # ─── 35 ──────────────────────────────────────────────
  {
    "slug":        "ravioli-ricotta-spinaci-ricetta",
    "title":       "Ravioli Ricotta e Spinaci Fatti in Casa — La Ricetta Originale della Pasta Ripiena",
    "desc":        "La ricetta dei ravioli ricotta e spinaci fatti in casa: sfoglia all'uovo sottilissima, ripieno cremoso di ricotta e spinaci con noce moscata. La pasta ripiena italiana più amata.",
    "tag":         "Primi",
    "tag_color":   "#2e7d32",
    "tag_bg":      "#e8f5e9",
    "h1":          "Ravioli Ricotta e Spinaci Fatti in Casa — La Pasta Ripiena Italiana Perfetta",
    "intro":       "I ravioli ricotta e spinaci sono la pasta ripiena italiana più amata al mondo: una sfoglia all'uovo sottile e setosa che racchiude un ripieno cremoso di ricotta fresca, spinaci saltati in burro e noce moscata. Conditi con burro fuso e salvia — il modo più puro di valorizzare la pasta fresca — o con un sugo di pomodoro leggero, sono un piatto di eleganza senza ostentazione. Farli in casa richiede tempo e cura, ma il risultato — la sfoglia che si stacca dal dente, il ripieno che esplode in bocca — è qualcosa che nessun raviolo industriale potrà mai replicare. Questa è la pasta della domenica, del pranzo speciale, del rituale culinario italiano.",
    "prep":        "1h", "cook": "5 min", "total": "1h 5min",
    "servings":    "4 porzioni", "calories": "~420", "difficulty": "Avanzato",
    "badge_text":  "Pasta Fresca",
    "cuisine":     "Italiana",
    "category":    "Primi",
    "keywords":    "ravioli ricotta spinaci ricetta, ravioli fatti in casa ricetta, pasta ripiena ricotta spinaci, ravioli ricetta originale, come fare i ravioli",
    "cal_num":     "420", "protein": "18g", "fat": "18g", "carbs": "46g",
    "ingredients": [
      "300g farina 00 (o semolino rimacinato per una sfoglia più rustica)",
      "3 uova intere grandi a temperatura ambiente",
      "1 cucchiaio olio extravergine d'oliva",
      "1 pizzico di sale",
      "300g ricotta fresca intera (ben sgocciolata)",
      "300g spinaci freschi (o 200g spinaci surgelati, ben strizzati)",
      "80g Parmigiano Reggiano DOP grattugiato",
      "1 uovo intero (per il ripieno)",
      "Noce moscata grattugiata fresca q.b.",
      "Sale, pepe nero",
      "80g burro (per condire)",
      "8-10 foglie di salvia fresca",
      "Parmigiano Reggiano grattugiato per servire",
    ],
    "steps": [
      "Prepara la pasta: metti la farina a fontana su una spianatoia, rompi le uova al centro, aggiungi l'olio e il sale. Sbatti le uova con una forchetta incorporando gradualmente la farina dai bordi. Quando l'impasto comincia a compattarsi, lavora a mano per 8-10 minuti fino a ottenere una pasta liscia, elastica e setosa — il test: premendo con il pollice, l'impronta deve scomparire lentamente. Avvolgi in pellicola e lascia riposare 30 minuti a temperatura ambiente. Il riposo è fondamentale: il glutine si rilassa e la pasta diventa stendibile senza tornare indietro.",
      "Prepara il ripieno: lessa gli spinaci freschi in acqua bollente salata per 2-3 minuti, scolali e strizzali fortissimo — devono essere asciuttissimi. Trita gli spinaci finemente. In una padella, sciogli 20g di burro e salta gli spinaci tritati 2 minuti per asciugarli ulteriormente. In una ciotola, mescola ricotta sgocciolata, spinaci, Parmigiano, l'uovo, noce moscata grattugiata abbondante, sale e pepe. Il ripieno deve essere compatto e non molle — se fosse troppo morbido, aggiungi Parmigiano o pane grattugiato.",
      "Stendi la sfoglia: dividi la pasta in 4 parti. Con la macchina per la pasta (o mattarello), stendi ogni parte progressivamente fino al penultimo livello (4-5 sulla maggior parte delle macchine) — la sfoglia deve essere quasi trasparente, circa 1-1,5mm. Lavora su una spianatoia leggermente infarinata. Copri le sfoglie non ancora usate con un panno umido per evitare che si asciughino.",
      "Forma i ravioli: disponi una sfoglia su un piano infarinato. Con un cucchiaino o una sac-à-poche, deposita mucchietti di ripieno (circa 1 cucchiaino) a distanza di 3-4cm l'uno dall'altro. Spennella leggermente la sfoglia intorno al ripieno con acqua (o albume diluito). Adagia la seconda sfoglia sopra e premi bene intorno a ogni mucchietto di ripieno espellendo l'aria — l'aria intrappolata fa aprire i ravioli durante la cottura.",
      "Taglia i ravioli con una rotella dentata o un tagliapasta quadrato (5-6cm). Premi i bordi con le dita per sigillare ulteriormente. Disponi i ravioli su vassoi infarinati senza sovrapporli. Cuocili entro 2-3 ore o congelali immediatamente in singolo strato.",
      "Cuoci i ravioli: porta a ebollizione abbondante acqua salata. Cuoci i ravioli in piccole quantità (non tutti insieme) per 3-4 minuti dall'affioramento. I ravioli freschi cuociono molto più velocemente della pasta secca. Nel frattempo, scioglie il burro in una padella larga, aggiungi le foglie di salvia e cuoci a fuoco medio-basso fino a quando il burro diventa dorato e profuma di nocciola (burro nocciola). Scola i ravioli con la schiumarola e versali direttamente nella padella con il burro. Mescola delicatamente. Servi subito con Parmigiano abbondante.",
    ],
    "tips": [
      "Riposo dell'impasto: 30 minuti minimi — senza riposo la pasta è elastica e si ritira durante la stesura.",
      "Ripieno asciutto: strizza gli spinaci al massimo. Il ripieno molle bagna la sfoglia e apre i ravioli in cottura.",
      "Espelli l'aria: premi bene intorno al ripieno prima di tagliare — l'aria fa scoppiare i ravioli.",
      "Burro nocciola: cuoci il burro fino a doratura dorata — il profumo di nocciola è la firma del piatto.",
    ],
    "prose1_h2":  "Le Origini dei Ravioli: dalla Liguria al Mondo",
    "prose1":     """I ravioli sono una delle paste ripiene più antiche d'Italia, con una storia documentata che risale al XIV secolo. La prima menzione scritta appare nelle lettere del mercante Francesco di Marco Datini (1383): 'ravioli' come piccoli involucri di pasta ripieni. Le origini geografiche sono contese: la Liguria rivendica la paternità (i 'ravioli di magro' liguri con ripieno di erbette e formaggio sono ancora oggi un classico), così come l'Emilia-Romagna e la Toscana. Il nome probabilmente deriva dall'italiano arcaico 'ravvolgere' (avvolgere) o dall'arabo 'raviolo' (piccolo involucro). I ravioli ricotta e spinaci — la versione più diffusa nel mondo — riflettono la cucina 'di magro' (senza carne) che caratterizzava i giorni di digiuno nella tradizione cattolica italiana, dove il ripieno di ricotta e verdure sostituiva la carne.""",
    "prose2_h2":  "Come Conservare i Ravioli Freschi: Frigo, Freezer e Vassoio",
    "prose2":     """I ravioli freschi sono deperibili: se non li cuoci subito, devono essere conservati correttamente. In frigorifero: disponi i ravioli su un vassoio ben infarinato, copri con pellicola, consuma entro 12-24 ore. Dopo, la sfoglia si ammorbidisce e si rischia che i ravioli si incollino o si aprano in cottura. In freezer (il metodo migliore): metti i ravioli crudi su un vassoio infarinato in singolo strato, congela per 1-2 ore fino a indurimento, poi trasferiscili in sacchetti zip. Si conservano 2 mesi. Cuoci direttamente da congelati: 5-6 minuti in acqua bollente salata. Il condimento classico è burro e salvia, ma i ravioli ricotta e spinaci sono ottimi anche con un sugo di pomodoro fresco leggero, con gorgonzola sciolto in panna (per una versione più ricca) o con burro fuso, limone e noci tritate.""",
    "img2_alt":   "Ravioli ricotta e spinaci fatti in casa conditi con burro nocciola e foglie di salvia croccanti, con Parmigiano grattugiato su piatto di ceramica",
    "prose3_h2":  "Varianti del Ripieno: Zucca, Carne, Patate e Tartufo",
    "prose3":     """La struttura della pasta fresca all'uovo rimane la stessa — è il ripieno a definire la personalità dei ravioli. Variante con ricotta e limone: sostituisci gli spinaci con scorza di limone grattugiata e menta fresca — fresco e profumato, condito con burro al limone. Variante con zucca: ravioli di zucca mantovani (con zucca, mostarda di Mantova e amaretti sbriciolati) — dolce e speziato, condito con burro e salvia. Variante con ricotta e prosciutto: aggiungi 80g di prosciutto crudo tritato finissimo al ripieno classico — più saporito, condito con burro e pomodorini. Variante con patate e toma (piemontese): ripieno di patate, burro e formaggio toma — rustico e profondo, condito con burro fuso e rosmarino. Variante di lusso: aggiungi tartufo nero grattugiato al ripieno di ricotta — condito solo con burro fuso senza salvia per non coprire il profumo del tartufo.""",
    "faqs": [
      ("I ravioli si possono fare senza la macchina per la pasta?", "Sì — con il mattarello si ottiene un risultato eccellente se si ha pazienza. La sfoglia deve essere stesa molto sottile (quasi trasparente, 1-2mm). Il vantaggio del mattarello è che la sfoglia è più rugosa e trattiene meglio il condimento. La macchina è più pratica e dà uno spessore più uniforme. Se usi il mattarello, riposa l'impasto 30 minuti in più e lavora su una superficie ampia."),
      ("Perché i miei ravioli si aprono in cottura?", "Cause principali: 1) Il ripieno era troppo morbido o bagnato — strizza meglio gli spinaci e aggiungi Parmigiano per compattare. 2) C'era aria intrappolata tra la sfoglia e il ripieno — premi bene intorno a ogni mucchietto. 3) I bordi non erano ben sigillati — usa acqua o albume per incollare e premi con forza. 4) Hai cotto troppi ravioli insieme — il rimescolamento in pentola li stressa. Cuoci in piccole quantità."),
      ("Posso fare i ravioli solo con la farina di semolino?", "La farina di semolino rimacinata dà una sfoglia più rustica, gialla e leggermente ruvida — tipica dell'Italia del Sud. La farina 00 dà una sfoglia più liscia e delicata — tipica dell'Emilia-Romagna. La miscela 50/50 è il compromesso perfetto: struttura e delicatezza. Evita la semola grossa (non rimacinata) per i ravioli: è troppo granulosa e rompe la sfoglia sottile."),
      ("Quale salsa abbinare ai ravioli ricotta e spinaci?", "Il condimento classico è burro nocciola e salvia — il burro tostato dà profondità senza coprire il ripieno delicato. Un sugo di pomodoro fresco leggero (senza troppa acidità) funziona benissimo. Per una versione più ricca: panna, burro e noci. Per una versione estiva: olio EVO crudo, limone, scorza e qualche foglia di basilico. Evita i sughi troppo forti (ragù, amatriciana) che coprono completamente il sapore del ripieno."),
      ("Come si fanno i ravioli grandi (ravioloni) invece di quelli piccoli?", "Per i ravioloni (formato gourmet), deposita mucchietti di ripieno più grandi (2 cucchiai) su una sfoglia, distanziandoli di 5-6cm. La sfoglia superiore deve essere leggermente più larga per coprire il ripieno più alto. Cuoci i ravioloni 5-6 minuti — la massa maggiore richiede più tempo. I ravioloni si presentano da soli nel piatto (2-3 per porzione) e sono perfetti per i ristoranti grazie all'impatto visivo."),
    ],
  },

  # ─── 36 ──────────────────────────────────────────────
  {
    "slug":        "torta-della-nonna-ricetta",
    "title":       "Torta della Nonna Ricetta Originale — Il Dolce Toscano con Crema e Pinoli",
    "desc":        "La vera ricetta della torta della nonna toscana: pasta frolla friabile, crema pasticcera alla vaniglia profumata e pinoli dorati in superficie. Il dolce italiano classico più rassicurante.",
    "tag":         "Dolci",
    "tag_color":   "#f57f17",
    "tag_bg":      "#fffde7",
    "h1":          "Torta della Nonna Ricetta Originale — La Crema Pasticcera e i Pinoli della Tradizione Toscana",
    "intro":       "La torta della nonna è uno dei dolci più amati della cucina italiana: un guscio di pasta frolla friabile e burrosa che racchiude una crema pasticcera alla vaniglia densa e profumata, coronata da pinoli tostati in superficie. Nasce a Firenze — o almeno così vuole la tradizione — e si è diffusa in tutta Italia come simbolo del dolce casalingo, della pasticceria senza pretese che conquista per la sua semplicità. Il nome 'della nonna' non è romanticismo gratuito: è proprio il tipo di dolce che le nonne toscane preparavano per i nipoti, con ingredienti semplici, tecnica rodatissima, e un risultato che non stanca mai.",
    "prep":        "30 min", "cook": "40 min", "total": "1h 10min",
    "servings":    "8 porzioni", "calories": "~380", "difficulty": "Medio",
    "badge_text":  "Torta",
    "cuisine":     "Toscana",
    "category":    "Dolci",
    "keywords":    "torta della nonna ricetta originale, torta della nonna ricetta, torta della nonna crema pasticcera, torta nonna toscana, ricetta torta della nonna con pinoli",
    "cal_num":     "380", "protein": "8g", "fat": "19g", "carbs": "44g",
    "ingredients": [
      "300g farina 00",
      "150g burro freddo a cubetti",
      "120g zucchero a velo",
      "2 tuorli + 1 uovo intero (per la frolla)",
      "Scorza di 1 limone biologico",
      "1 pizzico di sale",
      "500ml latte intero fresco",
      "4 tuorli d'uovo (per la crema)",
      "120g zucchero semolato (per la crema)",
      "40g farina 00 (o 35g maizena) (per la crema)",
      "1 baccello di vaniglia (o 1 cucchiaino estratto di vaniglia naturale)",
      "Scorza di ½ limone biologico (per la crema)",
      "80g pinoli (preferibilmente italiani di Pisa o del Mediterraneo)",
      "1 tuorlo + 1 cucchiaio di latte (per lucidare)",
      "Zucchero a velo per spolverare",
    ],
    "steps": [
      "Prepara la crema pasticcera: scaldare il latte con la scorza di limone e il baccello di vaniglia inciso (o l'estratto) fino quasi all'ebollizione. Nel frattempo, sbatti i tuorli con lo zucchero fino a ottenere un composto chiaro e spumoso. Aggiungi la farina setacciata e mescola senza grumi. Versa il latte caldo a filo sul composto di tuorli mescolando continuamente. Rimetti tutto nella pentola e cuoci a fuoco medio-basso mescolando senza sosta con una frusta fino a che la crema si addensa (2-3 minuti dopo il bollore). Versa in una ciotola, copri con pellicola a contatto (evita la pellicola in superficie — si forma la pelle) e lascia raffreddare completamente in frigorifero.",
      "Prepara la pasta frolla con il metodo sabbiato: versa la farina e il burro freddo a cubetti in una ciotola e lavora velocemente con le dita fino a ottenere un composto sabbioso. Aggiungi zucchero a velo, sale, scorza di limone, i tuorli e l'uovo intero. Impasta brevemente fino a formare un impasto compatto. Avvolgi in pellicola e riposa in frigorifero almeno 30 minuti.",
      "Preriscalda il forno a 175°C statico. Imburra e infarina uno stampo da 24cm. Dividi la frolla: ⅔ per la base, ⅓ per la copertura. Stendi la base a 4-5mm di spessore, adagiala nello stampo, premi bene lungo i bordi. Elimina l'eccesso. Punzecchia il fondo con una forchetta.",
      "Togli la crema pasticcera dal frigorifero, mescola bene con una spatola per renderla nuovamente liscia e versala sulla base di frolla. Livella la superficie con una spatola. Lo strato di crema deve essere uniforme e non raggiungere il bordo della frolla (lascia 5mm liberi).",
      "Stendi il ⅓ di frolla rimasto a 3-4mm di spessore. Adagiala delicatamente sulla crema come copertura. Sigilla bene i bordi premendo con le dita o con i rebbi di una forchetta. Bucherella la superficie con una forchetta. Spennella con il tuorlo mescolato al latte per la doratura.",
      "Distribuisci i pinoli sulla superficie in modo uniforme, premendoli leggermente per farli aderire alla frolla spennellata. I pinoli devono essere abbondanti: coprono quasi completamente la superficie. Inforna per 35-40 minuti fino a quando la frolla è dorata e i pinoli sono tostati e profumati. Lascia raffreddare completamente nel stampo prima di sformare. Spolvera con zucchero a velo prima di servire.",
    ],
    "tips": [
      "Crema a contatto con la pellicola: la pellicola direttamente sulla crema evita la formazione della pellicola in superficie.",
      "Crema completamente fredda: non versare la crema calda sulla frolla cruda — si ammorbidisce e non si taglia bene.",
      "Pinoli italiani: i pinoli del Mediterraneo (più piccoli) sono più saporiti e tostano meglio dei cinesi (più grandi e insipidi).",
      "Lascia raffreddare completamente: la torta calda è fragile — aspetta almeno 2 ore prima di sformarla.",
    ],
    "prose1_h2":  "Le Origini Fiorentine della Torta della Nonna",
    "prose1":     """La torta della nonna è toscana di nascita — Firenze rivendica la paternità con più forza, sebbene Livorno e Pisa abbiano le loro versioni storiche ugualmente radicate. La ricetta come la conosciamo oggi si codifica nella seconda metà del Novecento, quando la pasticceria casalinga italiana vive il suo periodo d'oro. Il nome 'della nonna' identifica un tipo di dolce: semplice, non sofisticato, che si fa con ingredienti di dispensa. La crema pasticcera e la pasta frolla sono le basi della pasticceria italiana — averle entrambe in un dolce significa padronanza completa delle tecniche fondamentali. I pinoli di Pisa (i più pregiati, coltivati nella pineta costiera toscana) non sono una decorazione casuale: il pino domestico è iconico del paesaggio toscano, e i pinoli sono stati ingrediente della cucina toscana sin dall'epoca romana. La 'torta del nonno' — variante con crema al cioccolato e granella di nocciole invece dei pinoli — è il corrispettivo maschile inventato dai pasticceri moderni.""",
    "prose2_h2":  "Crema Pasticcera Perfetta: i Segreti per Non Formare Grumi",
    "prose2":     """La crema pasticcera è la base di centinaia di dolci italiani — e la più sbagliata dai cuochi casalinghi. I problemi più comuni: grumi, consistenza irregolare, pellicola in superficie. Come evitarli: il latte non deve mai bollire violentemente quando si versa sui tuorli (inattiva le proteine creando grumi). Versa sempre il latte caldo a filo, non tutto insieme. Mescola sempre con la frusta — non con il cucchiaio: la frusta incorpora aria e rompe i grumi potenziali. Il fuoco durante la cottura in pentola deve essere medio-basso: il fuoco alto brucia la crema sul fondo prima che si addensi uniformemente. La crema è pronta quando 'vela il cucchiaio' (o quando è densa come uno yogurt). Se si formano grumi nonostante tutto, passa la crema al setaccio fine o usa il frullatore a immersione per 30 secondi: torna liscia perfettamente.""",
    "img2_alt":   "Torta della nonna toscana con pinoli dorati in superficie e fetta tagliata che mostra la crema pasticcera gialla densa su pasta frolla friabile",
    "prose3_h2":  "Varianti della Torta della Nonna e Come Conservarla",
    "prose3":     """Variante al limone: aggiungi scorza di 2 limoni alla crema pasticcera e guarnisci con fettine di limone candito — fresca e profumata. Variante alla crema di pistacchi: sostituisci 100g di farina nella crema con 80g di pasta di pistacchi di Bronte — la crema diventa verde brillante e intensamente saporita. Variante 'del nonno': crema al cioccolato (aggiungi 50g di cacao amaro alla crema base) e granella di nocciole invece dei pinoli — più intensa. Variante moderna: usa la crema alla ricotta (come per i cannoli) invece della pasticcera — più leggera, con sapore di ricotta fresca. Conservazione: la torta della nonna si conserva in frigorifero per 3-4 giorni (la crema pasticcera è deperibile — non lasciarla a temperatura ambiente per più di 2 ore). Prima di servire, tira fuori dal frigo 20-30 minuti: la frolla fredda perde friabilità. Scongela: la torta non si presta al congelamento — la crema pasticcera cambia consistenza.""",
    "faqs": [
      ("Posso usare la crema pasticcera già pronta del supermercato?", "Sì — le creme pronte in brick di qualità funzionano bene per la torta della nonna. Scegli una crema densa (non quella liquida per crostate fredde). Il risultato sarà leggermente meno profumato della versione con vaniglia fresca, ma perfettamente buono. Per migliorarla, aggiungi scorza di limone grattugiata e qualche goccia di estratto di vaniglia naturale."),
      ("Perché la mia torta della nonna perde liquido dopo il taglio?", "La crema pasticcera troppo liquida o non completamente raffreddata 'piange' dopo il taglio. Assicurati che la crema sia densa (non colante dal cucchiaio) e completamente fredda prima di versarla sulla frolla. Se la crema è troppo liquida, rimettila in pentola e cuoci ancora mescolando. Una crema ben fatta rimane compatta anche dopo il taglio."),
      ("I pinoli si possono sostituire?", "Sì — con mandorle a lamelle (classico per la torta alle mandorle), granella di pistacchi (versione siciliana), nocciole tritate (per la variante 'del nonno'), o sesamo bianco tostato (per una versione orientale). I pinoli italiani sono i più saporiti: cerca quelli del Mediterraneo (più piccoli e marroni) invece dei cinesi (più grandi e bianchi)."),
      ("Come si fa la torta della nonna senza stampo da crostata?", "Uno stampo a cerniera da 24cm funziona perfettamente — imburra bene i bordi. Puoi usare anche una tortiera usa-e-getta di alluminio. L'importante è che lo stampo abbia i bordi alti almeno 3cm (la crema ha un certo volume). Senza stampo a perdere, usa la carta forno per foderare il fondo e ungere i bordi per una sformatura più facile."),
      ("Qual è la differenza tra torta della nonna e crostata di crema?", "La differenza principale è la copertura: la crostata di crema ha il reticolo di frolla (come la crostata di marmellata, ma con crema). La torta della nonna ha una copertura piena di frolla (un disco intero) con i pinoli. La crema della torta della nonna è tipicamente più densa e profumata di vaniglia. La crostata di crema è più comune nel Sud Italia; la torta della nonna è tipicamente toscana."),
    ],
  },
